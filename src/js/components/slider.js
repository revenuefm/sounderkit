...
import {$, $$, addClass, css, data, includes, isNumeric, isUndefined, toggleClass, toFloat} from 'skit-util';
    ...
    update: {
        ...
        write() {
            ...
            $$(`[${this.attrItem}],[data-${this.attrItem}]`, this.$el).forEach(el => {
                ...
                this.maxIndex && toggleClass(el, 'sk-hidden', isNumeric(index) && (this.sets && !includes(this.sets, toFloat(index)) || index > this.maxIndex));
            });
