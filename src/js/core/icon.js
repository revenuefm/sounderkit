...
import {$, addClass, apply, css, each, hasClass, hyphenate, isRtl, isString, noop, parents, Promise, swap} from 'skit-util';
    ...
    Skit.icon.add = (name, svg) => {
        ...
        if (Skit._initialized) {
            apply(document.body, el =>
                each(Skit.getComponents(el), cmp => {
