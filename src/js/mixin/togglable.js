import {$$, Animation, assign, attr, css, fastdom, hasAttr, hasClass, height, includes, isBoolean, isFunction, isUndefined, isVisible, noop, Promise, toFloat, toggleClass, toNodes, Transition, trigger} from 'skit-util';
        ...
        toggleElement(targets, show, animate) {
            return new Promise(resolve => {
                ...
                if (!this.queued || !isUndefined(animate) || !isUndefined(show) || !this.hasAnimation || targets.length < 2) {
                    ...
                    const [el] = toggled;
                    const inProgress = Animation.inProgress(el) && hasClass(el, 'sk-animation-leave')
