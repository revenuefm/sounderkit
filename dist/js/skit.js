/*! Skit 1.0.0 | http://sounder.fm | (c) 2018-2019 Sounder.fm | MIT License */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define('skit', factory) :
    (global = global || self, global.Skit = factory());
    ...
    function getCssVar(name) {
        ...
        if (!isIE) {
            return getStyles(docEl).getPropertyValue(("--sk-" + name));
        }

        if (!(name in vars)) {

            /* usage in css: .sk-name:before { content:"xyz" } */

            var element = append(docEl, document.createElement('div'));

            addClass(element, ("sk-" + name));
    ...
    function transition(element, props, duration, timing) {
        ...
        return Promise.all(toNodes(element).map(function (element) { return new Promise(function (resolve, reject) {
                ...
                once(element, 'transitionend transitioncanceled', function (ref) {
                    ...
                    clearTimeout(timer);
                    removeClass(element, 'sk-transition');
                    css(element, {
                        'transition-property': '',
                        'transition-duration': '',
                ...
                addClass(element, 'sk-transition');
                css(element, assign({
    ...
    var Transition = {
        ...
        inProgress: function(element) {
            return hasClass(element, 'sk-transition');
        }

    };

    var animationPrefix = 'sk-animation-';
    var clsCancelAnimation = 'sk-cancel-animation';
    ...
    function animate(element, animation, duration, origin, out) {
        ...
        return Promise.all(toNodes(element).map(function (element) { return new Promise(function (resolve, reject) {
                ...
                if (startsWith(animation, animationPrefix)) {
                    ...
                    if (origin) {
                        cls += " sk-transform-origin-" + origin;
                    }
    ...
    */
    ...
    function componentAPI (Skit) {
        ...
        Skit.component = function (name, options) {
            ...
            Skit[name] = function (element, data) {
                ...
                var component = Skit.component(name);
                ...
                function init(element) {
                    ...
                    var instance = Skit.getComponent(element, name);
            ...
            if (Skit._initialized && !opt.functional) {
                ...
                fastdom.read(function () { return Skit[name](("[sk-" + id + "],[data-sk-" + id + "]")); });
            }

            return components[name] = isPlainObject(options) ? opt : options;
        };

        Skit.getComponents = function (element) { return element && element[DATA] || {}; };
        Skit.getComponent = function (element, name) { return Skit.getComponents(element)[name]; };

        Skit.connect = function (node) {
    ...
    function boot (Skit) {
        ...
        var connect = Skit.connect;
        var disconnect = Skit.disconnect;
        ...
        function applyAttribute(ref) {
            ...
            var component = Skit.getComponent(target, name);
    ...
    function globalAPI (Skit) {
        ...
        Skit.extend = function (options) {
            ...
            var Super = this;
            var Sub = function SkitComponent (options) {
                this._init(options);
            };
    ...
    function hooksAPI (Skit) {

        Skit.prototype._callHook = function (hook) {
            var this$1 = this;
        ...
        Skit.prototype._callConnected = function () {
        ...
        Skit.prototype._callDisconnected = function () {
        ...
        Skit.prototype._callUpdate = function (e) {
            var this$1 = this;
    ...
    function stateAPI (Skit) {

        var uid = 0;

        Skit.prototype._init = function (options) {
        ...
        Skit.prototype._initData = function () {
        ...
        Skit.prototype._initMethods = function () {
        ...
        Skit.prototype._initComputeds = function () {
        ...
        Skit.prototype._callWatches = function () {
        ...
        Skit.prototype._initProps = function (props) {
        ...
        Skit.prototype._initEvents = function () {
            var this$1 = this;
        ...
        Skit.prototype._unbindEvents = function () {
            this._events.forEach(function (unbind) { return unbind(); });
            this._events = [];
        };

        Skit.prototype._initObserver = function () {
            var this$1 = this;
    ...
    function instanceAPI (Skit) {
        ...
        Skit.prototype.$destroy = function (removeEl) {
            ...
            toggleElement: function(targets, show, animate) {
                ...
                return new Promise(function (resolve) {
                    ...
                    if (!this$1.queued || !isUndefined(animate) || !isUndefined(show) || !this$1.hasAnimation || targets.length < 2) {
                        ...
                        var el = toggled[0];
                        var inProgress = Animation.inProgress(el) && hasClass(el, 'sk-animation-leave')
            ...
            _toggleElement: function(el, show, animate) {
                ...
                show = isBoolean(show)
                    ...
                    : Animation.inProgress(el)
                        ? hasClass(el, 'sk-animation-leave')
    ...
    var Accordion = {
        ...
        data: {
            ...
            multiple: false,
            clsOpen: 'sk-open',
            toggle: '> .sk-accordion-title',
            content: '> .sk-accordion-content',
            transition: 'ease'
        },
    ...
    function Core (Skit) {
        ...
        ready(function () {
            ...
            Skit.update();
            on(window, 'load resize', function () { return Skit.update(null, 'resize'); });
            on(document, 'loadedmetadata load', function (ref) {
                var target = ref.target;

                return Skit.update(target, 'resize');
            }, true);
    ...
    var Drop = {
        ...
        computed: {
            ...
            clsDrop: function(ref) {
                ...
                return clsDrop || ("sk-" + (this.$options.name));
            },
    ...
    var Margin = {
        ...
        data: {
            margin: 'sk-margin-small-top',
            firstColumn: 'sk-first-column'
        },
    ...
    var Grid = {
        ...
        data: {
            margin: 'sk-grid-margin',
            clsStack: 'sk-grid-stack',
            masonry: false,
            parallax: 0
        },
        ...
        connected: function() {
            this.masonry && addClass(this.$el, 'sk-flex-top sk-flex-wrap-top');
        },
    ...
    var Slidenav = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'sk-slidenav-large')
                    ? (icon + "-large")
                    : icon;
            }
    ...
    var Search = {
        ...
        computed: {
            ...
            icon: function(ref, $el) {
                ...
                return hasClass($el, 'sk-search-icon') && parents($el, '.sk-search-large').length
                    ? 'search-large'
                    : parents($el, '.sk-search-navbar').length
                        ? 'search-navbar'
                        : icon;
            }
    ...
    var Close = {
        ...
        computed: {
            ...
            icon: function() {
                return ("close-" + (hasClass(this.$el, 'sk-close-large') ? 'large' : 'icon'));
            }
    ...
    function install(Skit) {
        Skit.icon.add = function (name, svg) {
            var obj;
            ...
            if (Skit._initialized) {
                apply(document.body, function (el) { return each(Skit.getComponents(el), function (cmp) {
    ...
    var Leader = {
        ...
        data: {
            fill: '',
            clsWrapper: 'sk-leader-fill',
            clsHide: 'sk-leader-hide',
            attrFill: 'data-fill'
        },
    ...
    function install$1 (Skit) {

        Skit.modal.dialog = function (content, options) {

            var dialog = Skit.modal((" <div class=\"sk-modal\"> <div class=\"sk-modal-dialog\">" + content + "</div> </div> "), options);
        ...
        Skit.modal.alert = function (message, options) {
            ...
            return new Promise(
                function (resolve) { return on(Skit.modal.dialog((" <div class=\"sk-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"sk-modal-footer sk-text-right\"> <button class=\"sk-button sk-button-primary sk-modal-close\" autofocus>" + (options.labels.ok) + "</button> </div> "), options).$el, 'hide', resolve); }
            );
        };
        ...
        Skit.modal.confirm = function (message, options) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var confirm = Skit.modal.dialog((" <form> <div class=\"sk-modal-body\">" + (isString(message) ? message : html(message)) + "</div> <div class=\"sk-modal-footer sk-text-right\"> <button class=\"sk-button sk-button-default sk-modal-close\" type=\"button\">" + (options.labels.cancel) + "</button> <button class=\"sk-button sk-button-primary\" autofocus>" + (options.labels.ok) + "</button> </div> </form> "), options);
        ...
        Skit.modal.prompt = function (message, value, options) {
            ...
            return new Promise(function (resolve) {
                ...
                var prompt = Skit.modal.dialog((" <form class=\"sk-form-stacked\"> <div class=\"sk-modal-body\"> <label>" + (isString(message) ? message : html(message)) + "</label> <input class=\"sk-input\" autofocus> </div> <div class=\"sk-modal-footer sk-text-right\"> <button class=\"sk-button sk-button-default sk-modal-close\" type=\"button\">" + (options.labels.cancel) + "</button> <button class=\"sk-button sk-button-primary\">" + (options.labels.ok) + "</button> </div> </form> "), options),
    ...
    var Navbar = {
        ...
        data: {
            dropdown: '.sk-navbar-nav > li',
            align: !isRtl ? 'left' : 'right',
            clsDrop: 'sk-navbar-dropdown',
            mode: undefined,
            offset: undefined,
            delayShow: undefined,
            delayHide: undefined,
            ...
            duration: 200,
            forceHeight: true,
            selMinHeight: '.sk-navbar-nav > li > a, .sk-navbar-item, .sk-navbar-toggle'
        },
        ...
        beforeConnect: function() {
            ...
            this.dropbar = dropbar && (query(dropbar, this.$el) || $('+ .sk-navbar-dropbar', this.$el) || $('<div></div>'));

            if (this.dropbar) {

                addClass(this.dropbar, 'sk-navbar-dropbar');

                if (this.dropbarMode === 'slide') {
                    addClass(this.dropbar, 'sk-navbar-dropbar-slide');
                }
            }
    ...
    var Offcanvas = {
        ...
        data: {
            ...
            flip: false,
            overlay: false,
            clsPage: 'sk-offcanvas-page',
            clsContainer: 'sk-offcanvas-container',
            selPanel: '.sk-offcanvas-bar',
            clsFlip: 'sk-offcanvas-flip',
            clsContainerAnimation: 'sk-offcanvas-container-animation',
            clsSidebarAnimation: 'sk-offcanvas-bar-animation',
            clsMode: 'sk-offcanvas',
            clsOverlay: 'sk-offcanvas-overlay',
            selClose: '.sk-offcanvas-close'
        },
    ...
    var Scrollspy = {
        ...
        data: function () { return ({
            ...
            repeat: false,
            delay: 0,
            inViewClass: 'sk-scrollspy-inview'
        }); },
                ...
                read: function(els) {
                    ...
                    this.elements.forEach(function (el, i) {
                        ...
                        if (!elData || elData.el !== el) {
                            var cls = data(el, 'sk-scrollspy-class');
    ...
    var Sticky = {
        ...
        data: {
            ...
            clsActive: 'sk-active',
            clsInactive: '',
            clsFixed: 'sk-sticky-fixed',
            clsBelow: 'sk-sticky-below',
            selTarget: '',
            widthElement: false,
            showOnUp: false,
            targetOffset: false
        ...
        connected: function() {
            this.placeholder = $('+ .sk-sticky-placeholder', this.$el) || $('<div class="sk-sticky-placeholder"></div>');
            this.isFixed = false;
            this.isActive = false;
        },
    ...
    var Switcher = {
        ...
        data: {
            ...
            swiping: true,
            cls: 'sk-active',
            clsContainer: 'sk-switcher',
            attrItem: 'sk-switcher-item',
            queued: true
        },
        ...
        methods: {
            ...
            show: function(item) {
                ...
                for (var i = 0; i < length; i++, next = (next + dir + length) % length) {
                    if (!matches(this.toggles[next], '.sk-disabled *, .sk-disabled, [disabled]')) {
    ...
    var Tab = {
        ...
        connected: function() {
            ...
            var cls = hasClass(this.$el, 'sk-tab-left')
                ? 'sk-tab-left'
    ...
    var targetClass = 'sk-animation-target';
    ...
    var SliderNav = {
        ...
        update: {
            ...
            write: function() {
                ...
                toggleClass($$(this.selNavItem, this.$el).concat(this.nav), 'sk-hidden', !this.maxIndex);
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    toggleClass(el, 'sk-invisible', this$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1.maxIndex));
                });
    ...
    var Slideshow = {
        ...
        data: {
            animation: 'slide',
            clsActivated: 'sk-transition-active',
    ...
    var LightboxPanel = {
        ...
        data: function () { return ({
            ...
            template: "<div class=\"sk-lightbox sk-overflow-hidden\"> <ul class=\"sk-lightbox-items\"></ul> <div class=\"sk-lightbox-toolbar sk-position-top sk-text-right sk-transition-slide-top sk-transition-opaque\"> <button class=\"sk-lightbox-toolbar-icon sk-close-large\" type=\"button\" sk-close></button> </div> <a class=\"sk-lightbox-button sk-position-center-left sk-position-medium sk-transition-fade\" href=\"#\" sk-slidenav-previous sk-lightbox-item=\"previous\"></a> <a class=\"sk-lightbox-button sk-position-center-right sk-position-medium sk-transition-fade\" href=\"#\" sk-slidenav-next sk-lightbox-item=\"next\"></a> <div class=\"sk-lightbox-toolbar sk-lightbox-caption sk-position-bottom sk-text-center sk-transition-slide-bottom sk-transition-opaque\"></div> </div>"
        }); },
...

            {
                ...
                handler: function(_, item) {
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i)) {
                        ...
                        var video = $(("<video controls playsinline" + (item.poster ? (" poster=\"" + (item.poster) + "\"") : '') + " sk-video=\"" + (this.videoAutoplay) + "\"></video>"));
    ...
    function install$2(Skit, Lightbox) {
    ...
    var Notification = {
        ...
        created: function() {
            ...
            this.$mount(append(container,
                ("<div class=\"" + (this.clsMsg) + (this.status ? (" " + (this.clsMsg) + "-" + (this.status)) : '') + "\"> <a href=\"#\" class=\"" + (this.clsClose) + "\" data-sk-close></a> <div>" + (this.message) + "</div> </div>")
            ));
    ...
    function install$3(Skit) {
        Skit.notification.closeAll = function (group, immediate) {
            apply(document.body, function (el) {
                var notification = Skit.getComponent(el, 'notification');
    ...
    var Slider$1 = {
        ...
        data: {
            center: false,
            sets: false,
            attrItem: 'sk-slider-item',
            selList: '.sk-slider-items',
            selNav: '.sk-slider-nav',
            clsContainer: 'sk-slider-container',
        ...
        update: {
            ...
            write: function() {
                ...
                $$(("[" + (this.attrItem) + "],[data-" + (this.attrItem) + "]"), this.$el).forEach(function (el) {
                    ...
                    this$1.maxIndex && toggleClass(el, 'sk-hidden', isNumeric(index) && (this$1.sets && !includes(this$1.sets, toFloat(index)) || index > this$1.maxIndex));
                });
    ...
    var Sortable = {
        ...
        data: {
            group: false,
            threshold: 5,
            clsItem: 'sk-sortable-item',
            clsPlaceholder: 'sk-sortable-placeholder',
            clsDrag: 'sk-sortable-drag',
            clsDragState: 'sk-drag',
            clsBase: 'sk-sortable',
            clsNoDrag: 'sk-sortable-nodrag',
            clsEmpty: 'sk-sortable-empty',
            clsCustom: '',
            handle: false
        },
    ...
    var Tooltip = {
        ...
        data: {
            ...
            title: '',
            delay: 0,
            animation: ['sk-animation-scale-up'],
            duration: 100,
            cls: 'sk-active',
            clsPos: 'sk-tooltip'
        },
    ...
    Skit.component('parallax', Parallax$1);
    Skit.component('slider', Slider$1);
    Skit.component('sliderParallax', SliderParallax);
    Skit.component('slideshow', Slideshow$1);
